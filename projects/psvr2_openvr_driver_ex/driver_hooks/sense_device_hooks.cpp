...
void SenseDeviceHooks::InstallHooks() {
  ...
  HookLib::InstallHook(reinterpret_cast<void *>(pHmdDriverLoader->GetBaseAddress() + 0x1A5760), reinterpret_cast<void *>(sie__psvr2__SenseDevice__ActivateHook),
  ...
  HookLib::InstallHook(reinterpret_cast<void *>(pHmdDriverLoader->GetBaseAddress() + 0x1A7a50),
                       reinterpret_cast<void *>(sie__psvr2__SenseDevice__DeactivateHook), reinterpret_cast<void **>(&sie__psvr2__SenseDevice__Deactivate));
}
