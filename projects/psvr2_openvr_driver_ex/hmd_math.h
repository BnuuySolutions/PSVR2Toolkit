...
public:
  ...
  static std::vector<vr::HmdVector2_t> ExtractInnerHAMPerimeter(const std::vector<vr::HmdVector2_t> &standardMesh) {
    ...
    perimeter.erase(std::unique(perimeter.begin(), perimeter.end(),
                                [epsilon](const vr::HmdVector2_t &a, const vr::HmdVector2_t &b) {
  ...
  static vr::HmdMatrix44_t convert34to44(const vr::HmdMatrix34_t &mat34) {
    ...
    mat44.m[0][0] = mat34.m[0][0];
    mat44.m[0][1] = mat34.m[0][1];
    mat44.m[0][2] = mat34.m[0][2];
    mat44.m[0][3] = mat34.m[0][3];
    mat44.m[1][0] = mat34.m[1][0];
    mat44.m[1][1] = mat34.m[1][1];
    mat44.m[1][2] = mat34.m[1][2];
    mat44.m[1][3] = mat34.m[1][3];
    mat44.m[2][0] = mat34.m[2][0];
    mat44.m[2][1] = mat34.m[2][1];
    mat44.m[2][2] = mat34.m[2][2];
    mat44.m[2][3] = mat34.m[2][3];
  ...
  static vr::HmdMatrix34_t convert44to34(const vr::HmdMatrix44_t &mat44) {
    ...
    // Copy rotation and translation
    mat34.m[0][0] = mat44.m[0][0];
    mat34.m[0][1] = mat44.m[0][1];
    mat34.m[0][2] = mat44.m[0][2];
    mat34.m[0][3] = mat44.m[0][3];
    mat34.m[1][0] = mat44.m[1][0];
    mat34.m[1][1] = mat44.m[1][1];
    mat34.m[1][2] = mat44.m[1][2];
    mat34.m[1][3] = mat44.m[1][3];
    mat34.m[2][0] = mat44.m[2][0];
    mat34.m[2][1] = mat44.m[2][1];
    mat34.m[2][2] = mat44.m[2][2];
    mat34.m[2][3] = mat44.m[2][3];
    return mat34;
  }
   ...
   */
  static float toRadians(float degrees) { return degrees * std::numbers::pi / 180.0f; }
