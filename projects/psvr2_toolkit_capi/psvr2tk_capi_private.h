...
#define PSVR2TK_CAPI_PRIVATE_FUNCTIONS(X)                                                                                                                      \
  ...
  X(int, psvr2_toolkit_private_send_gaze_set_command_checked, (GazeCalibrationCommand * pCommand), (pCommand))                                                 \
  X(int, psvr2_toolkit_private_send_gaze_get_command_checked, (GazeCalibrationCommand * pCommand), (pCommand))                                                 \
