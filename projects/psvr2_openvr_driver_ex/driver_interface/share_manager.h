...
struct VRSharedMemory {
    union {
        ...
        struct { uint8_t pad[0x8038]; uint32_t ctr; uint32_t data[4]; } img_setting_803c;
        struct { uint8_t pad[0x8054]; uint32_t ctr; uint32_t data[6]; } blob_cfg_8058;
        struct { uint8_t pad[0x8078]; uint32_t ctr; uint32_t data[4]; } ir_cam_807c;
        struct { uint8_t pad[0x8094]; uint32_t ctr; uint8_t data[0x400]; } cont_cfg_8098;
        struct {
            uint8_t pad[0x84a0];
            struct ArmModelSlot {
                uint32_t ctr;
        ...
        struct { uint8_t pad[0x8558]; uint32_t ctr; uint8_t data[0xC00]; } cont_led_855c;
        struct {
            uint8_t pad[0x9168];
        ...
        struct { uint8_t pad[0x9228]; uint32_t ctr; uint8_t data[0x48]; } fw_info1_922c;
        struct { uint8_t pad[0x927c]; uint32_t ctr; uint8_t data[0x850]; } fw_info2_9280;
        struct { uint8_t pad[0x9ad8]; uint32_t ctr; uint32_t pad2; uint8_t data[0x50]; } vr_dialog_9ae0;
        struct { uint8_t pad[0x9b38]; uint32_t ctr; uint8_t data[49]; } app_9b3c;
        struct { uint8_t pad[0x9b78]; uint32_t ctr; uint8_t data[0x80]; } vr_trace_9b7c;
        struct { uint8_t pad[0x9c88]; uint32_t ctr; uint8_t data[0x131]; } dbg_data_9c8c;
        struct { uint8_t pad[0x9de0]; uint32_t ctr; uint32_t data[4]; } scene_info_9de4;
        struct { uint8_t pad[0xa980]; uint32_t ctr; uint8_t data[0x90]; } tel_dev_a984;
        struct { uint8_t pad[0xaa9c]; uint32_t ctr; uint8_t data[0x1B50]; } tel_trk_aaa0;
        struct { uint8_t pad[0xc5f8]; uint32_t ctr; uint8_t data[0xA0]; } tel_pc_c600;
        struct { uint8_t pad[0xc738]; uint32_t ctr; uint8_t data[200]; } init_setup_c73c;
        struct { uint8_t pad[0xc810]; uint32_t ctr; uint32_t data; } playarea_setup_c814;
...
#define DEF_READ_MEMCPY_RET(FuncName, GroupIdx, MemGroup, MemData, Size) \
    uint32_t FuncName(this ShareManager& self, void* outData);

#define DEF_READ_MEMCPY_OUT(FuncName, GroupIdx, MemGroup, MemData, Size) \
    uint32_t FuncName(this ShareManager& self, void* outData, uint32_t* outCounter);
...
private:
    ...
    // The following members are not where the should be for ShareManager, or they don't exist.
