...
## Features
- Linux support (w/ [Ignition](https://github.com/BnuuySolutions/Ignition))
- Eye tracking (w/ calibration), camera feed\* (w/ Babble support) and assisted IPD adjustment
- Improved Play Area setup
- Improved controller prediction
- Improved controller haptics (PCM haptics)
- Improved controller tracking (custom LED sync)
- SteamVR Room View (passthrough), Night Mode and runtime refresh rate switching (NVIDIA-only) support
- Adaptive triggers
- Headset vibration\*
